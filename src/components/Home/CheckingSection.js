...
const CheckingSection = () => {
    ...
    return (
        <div className="flex w-full justify-center">
            <div className=' mx-4 bg-[#fff] px-6 shadow-lg min-h-[180px] mt-[-90px] relative xl:container w-full flex items-center '>
                <form onSubmit={handleSubmit(onSubmit)} className='grid gap-4 grid-cols-6 '>
                    ...
                    <input className='border h-12 px-4 bg-[#1CC3B2] text-white' type="submit" />
                </form>
            </div>
        </div>
    );
